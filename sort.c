...
static void partition(void **A, llint n, void *pivot, llint *first_eq, llint *first_gt, sort_compare_fn cmp)
{
...
static void quick_sort_recursive(void **A, llint n, sort_compare_fn cmp)
{
...
static void quick_sort_iterative(void **A, llint n, sort_compare_fn cmp)
{
    stack_t *stack=NULL;
...
static void merge(void **A, void **T, llint mid, llint n, sort_compare_fn cmp)
{
...
static void merge_sort_recursive(void **A, void **T, llint n, sort_compare_fn cmp)
{
    if (n<=1) { return; }
    llint middle=n/2;
...
static void merge_sort_iterative(void **A, void **T, llint n, sort_compare_fn cmp)
{
